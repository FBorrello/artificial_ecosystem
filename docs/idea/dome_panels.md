...
- **Materials**: Polycarbonate sheets 4 mm thick, bolts, silicon sealant.
- **Assembly and Manufacturing**: Each panel requires 2 full polycarbonate sheets (bulk format 2050x3050 mm, 4 mm thick). Sheets are dried for 24 hours before thermoforming. Internal panel is thermoformed first using a mold that creates the connector for pressurization, then cut to final size. External panel is thermoformed on a composite mold consisting of: sphere section (external mold), the internal panel, and internal mold (hard and soft parts). Thermoforming uses pressurization between panels and vacuum on the internal mold. After thermoforming, the internal panel remains trapped; remove hard part of internal mold, then soft part, then cut to final size. Transparent silicon is applied on the internal panel before mating. The internal mold creates negative curvature on the external panel to prevent condensation and bolt housing pockets via vacuum holes. Panels staggered by 1/3 panel width between layers.
- **Specifications**: Pressurized to 0.5 bar for structural strength, waterproof connections, staggered for load distribution.

## Wooden Panels Specifications
- **Parts**: Wooden frame (200x30 mm profiles), plywood panel enclosed in frame, wooden straps (200x30 mm profiles) screwed in X-shape on plywood connecting corners, 50 mm thick hard polystyrene panel on outermost side for spherical shape, 1 mm white PVC anti-UV wrap on wooden frame.
- **Materials**: Plywood panel (12 mm thick, sourced from lumber suppliers like Home Depot or local mills; available in standard formats 1220x2440 mm, 1250x2500 mm, 1525x3050 mm; custom cut to 2050x3050 mm for compatibility with polycarbonate sheets), 200x30 mm wood profiles for frame and straps (available lengths: 2-6 m, standard cross-section for framing), 50 mm thick hard polystyrene panel (sourced from insulation suppliers; available formats: 1200x600 mm, 1000x500 mm; cut and joined as needed), 1 mm thick white PVC sheets (sourced from plastic suppliers; rolls or sheets up to 2000x1000 mm).
- **Assembly and Manufacturing**: Cut wooden frame to trapezoid shape, enclose OSB panel, screw X-shaped straps on OSB, mount polystyrene panel on straps, wrap frame with PVC sheets, secure.
...
|-------|-------------------------|-----------------|-----------|
| 1 (44 PC, 14 Wood) | 13,200 | 2,800 | 16,000 |
| 2 (44 PC, 14 Wood) | 13,200 | 2,660 | 15,860 |
| 3 (44 PC, 14 Wood) | 13,200 | 2,380 | 15,580 |
| 4 (44 PC, 14 Wood) | 13,200 | 2,170 | 15,370 |
| 5 (44 PC, 14 Wood) | 13,200 | 1,960 | 15,160 |
| 6 (44 PC, 14 Wood) | 13,200 | 1,680 | 14,880 |
| 7 (44 PC, 14 Wood) | 13,200 | 1,400 | 14,600 |
| 8 (44 PC, 14 Wood) | 13,200 | 1,120 | 14,320 |
| 9 (1 Wood) | 0 | 180 | 180 |
| **Grand Total** | **105,600** | **16,350** | **121,950** |
